...
<div class="header">
	<div class="row justify-content-center">
		<h5 class="col col-6" style="font-size: xx-large; font-weight: bolder; text-align: center">게임 수정</h5>
	</div>
</div>
<div class="row justify-content-center p-3">
	...
	<div class="col col-12 col-md-6">
		<form:form modelAttribute="gameVO" method="post" id="form" action="../editok">
			...
			<div>
				<form:input id="form-pub" type="text" class="form-text form-control" placeholder="개발사" path="gamePublisher" required="true" onfocusout="upDate(this)"/>
				<p id="form-pub-invalid" class="form-invalid">개발사를 작성해 주세요</p>
			</div>
			<div>
				<form:input id="form-category" type="text" class="form-text form-control" placeholder="카테고리" path="category" required="true" onfocusout="upDate(this)"/>
			...
			<div>
				<form:textarea id="form-content" class="form-text form-control" placeholder="내용" path="content" required="true" onfocusout="upDate(this)"/>
			...
			<div class="col col-12 col-md-4">
				<label id="form-num-val" for="form-num">모집인원 (${gameVO.recruitNum}명)</label>
				<form:input id="form-num" type="range" min="1" max="10" step="1" path="recruitNum" class="form-range col col-12 col-md-3" required="true" onfocusout="upDateNum(this)" onchange="updateRage(this)"/>
